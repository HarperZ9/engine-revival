...
|---|---|---|
| Argonaut BRender v1.3.2 | R2 green; R4 closed in substance; **R5 opened** (game-shell state machine runs a deterministic frame loop over loaded period assets) | brender-archival nineteen-target ladder; audit rungs with JSON receipts |
