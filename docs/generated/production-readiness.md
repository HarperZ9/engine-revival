...
|---|---|---|---|---|---|---|---:|---|---|
| brender | portable-core-solid-shaded-render-smoke-passing | portable-core-library-and-solid-shaded-smoke-built | solid-shaded-render-smoke-passing | solid-shaded-render-smoke-passing | not-started | core-portability-audit-needed | 62 | brender-critical-edition-source-build; brender-v132-main-head; brender-3dmm-main-head; brender-v132-build-environment; brender-v132-portable-core-plan; brender-v132-harness-materializer-smoke; brender-v132-cmake-configure; brender-v132-core-build-attempt; brender-v132-period-defines-build-attempt; brender-v132-explicit-sources-core-build; brender-v132-vector-smoke-runtime; brender-v132-framework-startup-smoke-win32; brender-v132-portable-core-render-smoke; brender-v132-portable-core-scene-smoke; brender-v132-portable-core-fill-smoke | translate the softrend renderer device so BrZbModelRender can produce shaded and depth-buffered scene output; extend the scene smoke to load a model and materials from a BRender datafile; add semantic tests for portable core and host fallback behavior; audit and classify the MSVC warning transcript; translate the deferred FIXED variants after the core library and scene path are stable |
